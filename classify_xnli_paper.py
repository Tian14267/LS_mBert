...
from third_party.processors.utils_classify_codeswitch import (
...
def load_and_cache_examples(
    ...
    processor = PROCESSORS[task](args.covert_rate)
...
def main():
    ...
    parser.add_argument(
        "--data_dir",
        default="./download/xnli_udpipe_processed_es",
        type=str,
    ...
    parser.add_argument("--covert_rate", default=0.3, type=float, help="Covert rate")
    parser.add_argument(
        "--train_language",
        default="en",
        type=str,
    ...
    parser.add_argument(
        "--predict_languages",
        type=str,
        default="ar,bg,de,el,en,es,fr,hi,ru,tr,ur,vi,zh",
    ...
    parser.add_argument(
        "--output_dir",
        default="./outputs/xnli_syn_codeswitch_0830",
        type=str,
    ...
    parser.add_argument(
        "--do_predict", default=True, help="Whether to run prediction."
    )
    parser.add_argument(
    ...
    processor = PROCESSORS[args.task_name](args.covert_rate)
