...
def load_and_cache_examples(
    ...
    processor = PROCESSORS[task](args.train_language, args.covert_rate)
...
def main():
    ...
    parser.add_argument(
        "--data_dir",
        default="./download/pawsx_udpipe_processed_en",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        default="./outputs/pawsx_en_syn_codes_temp",
        type=str,
    ...
    processor = PROCESSORS[args.task_name](args.train_language, args.covert_rate)
